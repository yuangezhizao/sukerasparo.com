...
function audioplay(num) {
	...
	$('.svb1').attr('src','img/character_btn1.png');
	$('.svb2').attr('src','img/character_btn2.png');
	$('.svb3').attr('src','img/character_btn3.png');
	$('.svb4').attr('src','img/character_btn4.png');
	$('.svb5').attr('src','img/character_btn5.png');
	$('.svb6').attr('src','img/character_btn6.png');
	$('.svb7').attr('src','img/character_btn7.png');
	$('.svb8').attr('src','img/character_btn8.png');
	$('.svb9').attr('src','img/character_btn9.png');
	var dura = media.duration;
	media.play();
	$('.svb' +num ).attr('src','img/character_btn_playing.png');
	$(function () {
		setTimeout(function () {
			$('.svb' + num ).attr('src','img/character_btn' + num + '.png');
		}, dura * 1000);
	});
}
