$(window).on('load', function(){
	...
	setTimeout(function(){
		...
		$(".mas-up").stop().delay(3000).queue(function(){
			$(this).fadeIn(1000).animate({duration:1000,queue: false}).dequeue();
		});
		$(".infomation").stop().delay(3000).queue(function(){
			$(this).fadeIn(1000).animate({duration:1000,queue: false}).dequeue();
		});
...
$(document).ready(function(){
	$(".mv-logo-img01,.mv-logo-img02,.mas-up,.infomation,.mv-catch,#mv-demo").css({display: "none"});
...
if($(window).innerWidth() <= 1024){
	setTimeout(function(){
		...
		$(".mas-up").stop().delay(1500).queue(function(){
			$(this).fadeIn(1000).animate({duration:1000,queue: false}).dequeue();
		});
		$(".infomation").stop().delay(1500).queue(function(){
			$(this).fadeIn(1000).animate({duration:1000,queue: false}).dequeue();
		});
	...
	$(document).ready(function(){
		$(".mv-logo-img01,.mv-logo-img02,.mas-up,.infomation,.mv-catch").css({display: "none"});
...
function audioplay(num) {
	...
	$('.svb1').attr('src','/somero/oshilove/_img/character_btn1.png');
	$('.svb2').attr('src','/somero/oshilove/_img/character_btn2.png');
	$('.svb3').attr('src','/somero/oshilove/_img/character_btn3.png');
	$('.svb4').attr('src','/somero/oshilove/_img/character_btn4.png');
	$('.svb5').attr('src','/somero/oshilove/_img/character_btn5.png');
	$('.svb6').attr('src','/somero/oshilove/_img/character_btn6.png');
	$('.svb7').attr('src','/somero/oshilove/_img/character_btn7.png');
	$('.svb8').attr('src','/somero/oshilove/_img/character_btn8.png');
	$('.svb9').attr('src','/somero/oshilove/_img/character_btn9.png');
	var dura = media.duration;
	media.play();
	$('.svb' +num ).attr('src','/somero/oshilove/_img/character_btn_playing.png');
	$(function () {
		setTimeout(function () {
			$('.svb' + num ).attr('src','/somero/oshilove/_img/character_btn' + num + '.png');
		}, dura * 1000);
	});
}
